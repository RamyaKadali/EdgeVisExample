...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'RootWindow.SomePicture' at 6;8.", repo.RootWindow.SomePictureInfo, new RecordItemIndex(5));
            repo.RootWindow.SomePicture.Click("6;8");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'EdgeVisClient1.Close' at 30;10.", repo.EdgeVisClient1.CloseInfo, new RecordItemIndex(6));
